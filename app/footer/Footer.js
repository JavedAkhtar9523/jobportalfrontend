...
//         <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-purple-200 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse animation-delay-2000"></div>
//       </div>

//       <div className="relative max-w-7xl lg:mx-auto sm:mx-25 text-gray-800 px-5 py-12">
//         {/* Main Footer Content */}
//         <div className="border-b border-gray-200 pb-8 mb-8">
//           <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-8">
//             {/* Logo Section */}
//             <div className="space-y-6 p-2 group">
//               <div className="text-center transform transition-all duration-500 hover:scale-105">
//                 <div className="relative inline-block">
//                   <img
//                     src="Finalloo.svg"
//                     alt="Spreads Logo"
//                     className="w-16 h-16 m-auto transition-all duration-700 group-hover:rotate-12 group-hover:scale-110 drop-shadow-lg"
//                   />
...
//                 </div>
//                 <h1 className="text-2xl my-3 font-bold bg-gradient-to-r from-blue-600 to-blue-600 bg-clip-text text-transparent">
//                   Spreads
//                 </h1>
//               </div>
...
//                     target="_blank"
//                     rel="noopener noreferrer"
//                     className={`text-white ${item.bg} p-2.5 rounded-xl text-lg transform transition-all duration-300 hover:scale-125 hover:-translate-y-1 hover:shadow-lg hover:shadow-blue-200 animate-fade-in-up`}
...
//               >
//                 <h5 className="font-bold text-lg font-['Inter'] mb-4 text-gray-800 relative">
//                   {section.title}
//                   <div className="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-blue-500 to-blue-500 transition-all duration-500 group-hover:w-full"></div>
//                 </h5>
...
//                       <Link
//                         href={link.href}
//                         className="font-['Inter'] text-sm text-gray-600 hover:text-blue-600 transition-all duration-300 relative group/link"
//                       >
...
//         {/* Floating Elements */}
//         <div className="absolute top-10 right-10 w-2 h-2 bg-blue-400 rounded-full animate-bounce opacity-60"></div>
//         <div className="absolute bottom-20 left-10 w-1 h-1 bg-blue-400 rounded-full animate-ping opacity-40"></div>
//       </div>
