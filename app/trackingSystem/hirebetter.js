  ...
  return (
    <section className="md:p-20 p-8 bg-[#358185] ">
        ...
        {/* CTA Button */}
          ...
          <LinkButton redirection='/login' name = "Explore All Featured" linkclassname=" bg-transparent border  border-white hover:bg-[#033C3F] hover:scale-110 transition-all duration-300" />
